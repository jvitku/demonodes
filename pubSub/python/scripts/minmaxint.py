...
net=nef.Network('Neural module - find min and max, round to integer and publish')
...
finder = "org.hanns.demoNodes.pubsub.MinMaxInt";	# Java (ROS) node that does this job
...
neuron = NeuralModule('MinMaxFinderInt', g)    		# construct the Neural Module
...
neuron.createDecoder("rosoutput", "int", 2)    		# ..called ORIGIN of SimpleNode
