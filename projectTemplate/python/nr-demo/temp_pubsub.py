...
g = NodeGroup("temp_Publisher", True);        			
g.addNode(pub, "temp_Publisher", "java");     	# add the publisher node
module = AsynNeuralModule("temp_Publisher", g)    		
module.createDecoder("org/hanns/demonodes/pubsub", "float", 7) 
net.add(module)	

g2 = NodeGroup("temp_Subbscriber", True);        			
g2.addNode(sub, "temp_Subbscriber", "java");     	# add the publisher node
module2 = AsynNeuralModule("temp_Subscriber", g2)    		
